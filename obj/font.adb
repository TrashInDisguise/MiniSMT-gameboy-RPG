M:font
S:Lfont.set_2bpp_palette$palette$1_0$26({2}SI:U),B,1,-2
S:Lfont.set_1bpp_colors$bgcolor$1_0$29({1}SC:U),B,1,-1
S:Lfont.set_1bpp_colors$fgcolor$1_0$29({1}SC:U),B,1,-2
S:Lfont.set_bkg_based_tiles$w$1_0$35({1}SC:U),B,1,2
S:Lfont.set_bkg_based_tiles$h$1_0$35({1}SC:U),B,1,3
S:Lfont.set_bkg_based_tiles$tiles$1_0$35({2}DG,SC:U),B,1,4
S:Lfont.set_bkg_based_tiles$base_tile$1_0$35({1}SC:U),B,1,6
S:Lfont.set_bkg_based_tiles$y$1_0$35({1}SC:U),B,1,-1
S:Lfont.set_bkg_based_tiles$x$1_0$35({1}SC:U),B,1,-2
S:Lfont.set_bkg_based_submap$w$1_0$38({1}SC:U),B,1,2
S:Lfont.set_bkg_based_submap$h$1_0$38({1}SC:U),B,1,3
S:Lfont.set_bkg_based_submap$map$1_0$38({2}DG,SC:U),B,1,4
S:Lfont.set_bkg_based_submap$map_w$1_0$38({1}SC:U),B,1,6
S:Lfont.set_bkg_based_submap$base_tile$1_0$38({1}SC:U),B,1,7
S:Lfont.set_bkg_based_submap$y$1_0$38({1}SC:U),B,1,-1
S:Lfont.set_bkg_based_submap$x$1_0$38({1}SC:U),B,1,-2
S:Lfont.move_bkg$y$1_0$43({1}SC:U),B,1,-1
S:Lfont.move_bkg$x$1_0$43({1}SC:U),B,1,-2
S:Lfont.scroll_bkg$y$1_0$45({1}SC:S),B,1,-1
S:Lfont.scroll_bkg$x$1_0$45({1}SC:S),B,1,-2
S:Lfont.set_win_based_tiles$w$1_0$52({1}SC:U),B,1,2
S:Lfont.set_win_based_tiles$h$1_0$52({1}SC:U),B,1,3
S:Lfont.set_win_based_tiles$tiles$1_0$52({2}DG,SC:U),B,1,4
S:Lfont.set_win_based_tiles$base_tile$1_0$52({1}SC:U),B,1,6
S:Lfont.set_win_based_tiles$y$1_0$52({1}SC:U),B,1,-1
S:Lfont.set_win_based_tiles$x$1_0$52({1}SC:U),B,1,-2
S:Lfont.set_win_based_submap$w$1_0$55({1}SC:U),B,1,2
S:Lfont.set_win_based_submap$h$1_0$55({1}SC:U),B,1,3
S:Lfont.set_win_based_submap$map$1_0$55({2}DG,SC:U),B,1,4
S:Lfont.set_win_based_submap$map_w$1_0$55({1}SC:U),B,1,6
S:Lfont.set_win_based_submap$base_tile$1_0$55({1}SC:U),B,1,7
S:Lfont.set_win_based_submap$y$1_0$55({1}SC:U),B,1,-1
S:Lfont.set_win_based_submap$x$1_0$55({1}SC:U),B,1,-2
S:Lfont.move_win$y$1_0$60({1}SC:U),B,1,-1
S:Lfont.move_win$x$1_0$60({1}SC:U),B,1,-2
S:Lfont.scroll_win$y$1_0$62({1}SC:S),B,1,-1
S:Lfont.scroll_win$x$1_0$62({1}SC:S),B,1,-2
S:Lfont.SET_SHADOW_OAM_ADDRESS$address$1_0$67({2}DG,SV:S),B,1,-2
S:Lfont.set_sprite_tile$tile$1_0$69({1}SC:U),B,1,-1
S:Lfont.set_sprite_tile$nb$1_0$69({1}SC:U),B,1,-2
S:Lfont.get_sprite_tile$nb$1_0$71({1}SC:U),B,1,-1
S:Lfont.set_sprite_prop$prop$1_0$73({1}SC:U),B,1,-1
S:Lfont.set_sprite_prop$nb$1_0$73({1}SC:U),B,1,-2
S:Lfont.get_sprite_prop$nb$1_0$75({1}SC:U),B,1,-1
S:Lfont.move_sprite$y$1_0$77({1}SC:U),B,1,2
S:Lfont.move_sprite$x$1_0$77({1}SC:U),B,1,-1
S:Lfont.move_sprite$nb$1_0$77({1}SC:U),B,1,-2
S:Lfont.move_sprite$itm$1_0$78({2}DG,STOAM_item_t:S),B,1,-4
S:Lfont.scroll_sprite$y$1_0$79({1}SC:S),B,1,2
S:Lfont.scroll_sprite$x$1_0$79({1}SC:S),B,1,-1
S:Lfont.scroll_sprite$nb$1_0$79({1}SC:U),B,1,-2
S:Lfont.scroll_sprite$itm$1_0$80({2}DG,STOAM_item_t:S),B,1,-4
S:Lfont.hide_sprite$nb$1_0$81({1}SC:U),B,1,-1
S:Lfont.set_native_tile_data$data$1_0$89({2}DG,SC:U),B,1,2
S:Lfont.set_native_tile_data$nb_tiles$1_0$89({1}SC:U),B,1,-1
S:Lfont.set_native_tile_data$first_tile$1_0$89({2}SI:U),B,1,-3
S:Lfont.aligned_alloc$size$1_0$118({2}SI:U),B,1,-2
S:Lfont.aligned_alloc$alignment$1_0$118({2}SI:U),B,1,-4
F:G$return_letter$0_0$0({2}DF,DG,SC:U),Z,0,0,0,0,0
S:Lfont.return_letter$letter$1_0$0({1}SC:U),R,0,0,[e]
F:G$load_string$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfont.load_string$str_size$1_0$0({1}SC:U),R,0,0,[c]
S:Lfont.load_string$str$1_0$0({2}DG,SC:U),R,0,0,[e,d]
S:Lfont.load_string$i$1_0$128({1}SC:U),R,0,0,[b]
F:G$pull_letters$0_0$0({2}DF,DG,SC:U),Z,0,191,0,0,0
S:Lfont.pull_letters$vram_adr$1_0$135({1}SC:U),B,1,2
S:Lfont.pull_letters$str_size$1_0$0({1}SC:U),B,1,-6
S:Lfont.pull_letters$str$1_0$0({2}DG,SC:U),B,1,-5
S:Lfont.pull_letters$i$1_0$136({1}SC:U),B,1,-2
S:Lfont.pull_letters$j$1_0$136({1}SC:U),B,1,-1
S:Lfont.pull_letters$n$1_0$136({1}SC:U),B,1,-3
S:Lfont.pull_letters$unique_list$1_0$136({96}DA96d,SC:U),B,1,-201
S:Lfont.pull_letters$tileset$1_0$136({96}DA96d,SC:U),B,1,-105
S:Lfont.pull_letters$curr$1_0$136({1}SC:U),B,1,-9
S:Lfont.pull_letters$sloc0$0_1$0({1}SC:U),B,1,-3
S:Lfont.pull_letters$sloc1$0_1$0({1}SC:U),B,1,-2
S:Lfont.pull_letters$sloc2$0_1$0({1}SC:U),B,1,-9
S:Lfont.pull_letters$sloc3$0_1$0({1}SC:U),B,1,-1
S:Lfont.pull_letters$sloc4$0_1$0({2}DD,SC:U),B,1,-8
S:Lfont.pull_letters$sloc5$0_1$0({1}SC:U),B,1,-1
S:Lfont.pull_letters$sloc6$0_1$0({2}DG,SC:U),B,1,-8
S:Lfont.pull_letters$sloc7$0_1$0({1}SC:U),B,1,-2
T:Ffont$__00000000[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
T:Ffont$__00000001[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)]
T:Ffont$__00000002[({0}S:S$npads$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({4}S:S$joy3$0_0$0({1}SC:U),Z,0,0)({1}S:S$joypads$0_0$0({4}DA4d,SC:U),Z,0,0)]
T:Ffont$__00000003[({0}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy3$0_0$0({1}SC:U),Z,0,0)({0}S:S$joypads$0_0$0({4}DA4d,SC:U),Z,0,0)]
T:Ffont$__00000004[({0}S:S$joy0$0_0$0({1}SC:U),Z,0,0)({1}S:S$joy1$0_0$0({1}SC:U),Z,0,0)({2}S:S$joy2$0_0$0({1}SC:U),Z,0,0)({3}S:S$joy3$0_0$0({1}SC:U),Z,0,0)]
T:Ffont$_fixed[({0}S:S$l$0_0$0({1}SC:U),Z,0,0)({1}S:S$h$0_0$0({1}SC:U),Z,0,0)({0}S:S$b$0_0$0({2}ST__00000001:S),Z,0,0)({0}S:S$w$0_0$0({2}SI:U),Z,0,0)]
T:Ffont$OAM_item_t[({0}S:S$y$0_0$0({1}SC:U),Z,0,0)({1}S:S$x$0_0$0({1}SC:U),Z,0,0)({2}S:S$tile$0_0$0({1}SC:U),Z,0,0)({3}S:S$prop$0_0$0({1}SC:U),Z,0,0)]
...
S:G$font$0_0$0({1536}DA96d,DA16d,SC:U),D,0,0
