...
;src/main.c:84: if(dng[i*dng_width+j]==0x01){
	...
	jr	NZ, 00107$
	C$main.c$85$6_0$120	= .
	.globl	C$main.c$85$6_0$120
;src/main.c:85: player_x = j;
	ld	hl, #_player_x
	ld	(hl), b
	C$main.c$86$6_0$120	= .
	.globl	C$main.c$86$6_0$120
;src/main.c:86: player_y = i;
	ld	hl, #_player_y
	ld	(hl), c
00107$:
	C$main.c$83$4_0$118	= .
	.globl	C$main.c$83$4_0$118
;src/main.c:83: for(uint8_t j = 0; j < dng_height; j++){
	inc	b
	jr	00106$
00110$:
	C$main.c$82$2_0$116	= .
	.globl	C$main.c$82$2_0$116
;src/main.c:82: for(uint8_t i = 0; i < dng_width; i++){
	inc	c
	jr	00109$
00104$:
	C$main.c$90$1_0$115	= .
	.globl	C$main.c$90$1_0$115
;src/main.c:90: SHOW_BKG;
	ldh	a, (_LCDC_REG + 0)
	or	a, #0x01
	ldh	(_LCDC_REG + 0), a
	C$main.c$92$1_0$115	= .
	.globl	C$main.c$92$1_0$115
;src/main.c:92: }
	add	sp, #5
	pop	hl
	inc	sp
...
;src/main.c:99: check_l_walls(dng,dungeon_width,dungeon_hieght,player_x, player_y, player_dir);
	...
	pop	de
	pop	bc
	C$main.c$100$1_0$122	= .
	.globl	C$main.c$100$1_0$122
;src/main.c:100: check_r_walls(dng,dungeon_width,dungeon_hieght,player_x, player_y, player_dir);
	...
	pop	de
	pop	bc
	C$main.c$101$1_0$122	= .
	.globl	C$main.c$101$1_0$122
;src/main.c:101: check_m_walls(dng,dungeon_width,dungeon_hieght, player_x, player_y,player_dir);
	...
	ld	a, c
	call	_check_m_walls
	C$main.c$103$1_0$122	= .
	.globl	C$main.c$103$1_0$122
;src/main.c:103: }
	pop	hl
	inc	sp
	jp	(hl)
...
;../gbdk/include/gb/gb.h:1676: itm->y=y, itm->x=x;
	...
	ld	(hl+), a
	ld	(hl), #0x98
	C$main.c$122$3_0$126	= .
	.globl	C$main.c$122$3_0$126
...
;src/main.c:125: }
	...
	C$main.c$127$3_0$157	= .
	.globl	C$main.c$127$3_0$157
...
;../gbdk/include/gb/gb.h:1648: shadow_OAM[nb].prop=prop;
	...
	ld	(hl), #0x00
	C$main.c$133$1_0$157	= .
	.globl	C$main.c$133$1_0$157
;src/main.c:133: switch(player_dir){
	...
	jr	Z, 00104$
	jp	00105$
	C$main.c$134$2_0$158	= .
	.globl	C$main.c$134$2_0$158
...
;../gbdk/include/gb/gb.h:1648: shadow_OAM[nb].prop=prop;
	...
	ld	hl, #(_shadow_OAM + 15)
	ld	(hl), #0x60
	C$main.c$141$2_0$158	= .
	.globl	C$main.c$141$2_0$158
;src/main.c:141: break;
	jr	00105$
	C$main.c$143$2_0$158	= .
	.globl	C$main.c$143$2_0$158
...
;../gbdk/include/gb/gb.h:1648: shadow_OAM[nb].prop=prop;
	...
	ld	hl, #(_shadow_OAM + 7)
	ld	(hl), #0x40
	C$main.c$150$2_0$158	= .
	.globl	C$main.c$150$2_0$158
;src/main.c:150: break;
	jr	00105$
	C$main.c$152$2_0$158	= .
	.globl	C$main.c$152$2_0$158
...
;../gbdk/include/gb/gb.h:1648: shadow_OAM[nb].prop=prop;
	...
	ld	hl, #(_shadow_OAM + 11)
	ld	(hl), #0x60
	C$main.c$161$2_0$158	= .
	.globl	C$main.c$161$2_0$158
;src/main.c:161: break;
	jr	00105$
	C$main.c$163$2_0$158	= .
	.globl	C$main.c$163$2_0$158
...
;src/main.c:174: switch(player_dir){
	...
	jr	Z, 00109$
	jr	00110$
	C$main.c$175$2_0$159	= .
	.globl	C$main.c$175$2_0$159
...
;src/main.c:178: break;
	jr	00110$
	C$main.c$180$2_0$159	= .
	.globl	C$main.c$180$2_0$159
...
;src/main.c:183: break;
	jr	00110$
	C$main.c$185$2_0$159	= .
	.globl	C$main.c$185$2_0$159
...
;../gbdk/include/gb/gb.h:1602: shadow_OAM[nb].tile=tile;
	...
	ld	hl, #(_shadow_OAM + 22)
	ld	(hl), #0x0c
	C$main.c$190$2_0$159	= .
	.globl	C$main.c$190$2_0$159
;src/main.c:190: break;
	jr	00110$
	C$main.c$192$2_0$159	= .
	.globl	C$main.c$192$2_0$159
...
;../gbdk/include/gb/gb.h:1602: shadow_OAM[nb].tile=tile;
	...
	ld	hl, #(_shadow_OAM + 22)
	ld	(hl), #0x09
	C$main.c$196$1_0$157	= .
	.globl	C$main.c$196$1_0$157
;src/main.c:196: }
00110$:
;../gbdk/include/gb/gb.h:1602: shadow_OAM[nb].tile=tile;
...
;../gbdk/include/gb/gb.h:1648: shadow_OAM[nb].prop=prop;
	...
	ld	(hl), #0x60
	C$main.c$205$3_0$157	= .
	.globl	C$main.c$205$3_0$157
...
;src/main.c:214: if((joypad_current & J_LEFT) && !(joypad_previous & J_LEFT)){
	...
	bit	1, a
	jr	NZ, 00104$
	C$main.c$215$2_0$290	= .
	.globl	C$main.c$215$2_0$290
...
;src/main.c:216: if (player_dir==255){
	...
	inc	a
	jr	NZ, 00102$
	C$main.c$217$3_0$291	= .
	.globl	C$main.c$217$3_0$291
;src/main.c:217: player_dir = west;
	ld	hl, #_player_dir
	ld	(hl), #0x03
00102$:
	C$main.c$219$2_0$290	= .
	.globl	C$main.c$219$2_0$290
;src/main.c:219: update_dng(test_dungeon,15,15);
	...
	call	_update_dng
00104$:
	C$main.c$223$1_0$289	= .
	.globl	C$main.c$223$1_0$289
...
;src/main.c:224: player_dir++;
	ld	hl, #_player_dir
	inc	(hl)
	C$main.c$225$2_0$292	= .
	.globl	C$main.c$225$2_0$292
...
;src/main.c:226: player_dir=north;
	...
	ld	(hl), #0x00
00107$:
	C$main.c$228$2_0$292	= .
	.globl	C$main.c$228$2_0$292
;src/main.c:228: update_dng(test_dungeon,15,15);
	...
	call	_update_dng
00109$:
	C$main.c$231$1_0$289	= .
	.globl	C$main.c$231$1_0$289
;src/main.c:231: if((joypad_current & J_UP) && !(joypad_previous & J_UP)){
	...
	bit	2, a
	jp	NZ,00129$
	C$main.c$234$1_0$289	= .
	.globl	C$main.c$234$1_0$289
...
;src/main.c:232: switch(player_dir){
	...
	or	a, a
	jr	Z, 00111$
	C$main.c$240$1_0$289	= .
	.globl	C$main.c$240$1_0$289
...
;src/main.c:232: switch(player_dir){
	...
	jp	Z,00123$
	jp	00127$
	C$main.c$233$3_0$295	= .
	.globl	C$main.c$233$3_0$295
...
;src/main.c:234: if(return_value(test_dungeon,15,15,player_x,player_y-1)==0x00||return_value(test_dungeon,15,15,player_x,player_y-1)==0x01){
	...
	jp	NZ,00127$
00112$:
	C$main.c$235$4_0$296	= .
	.globl	C$main.c$235$4_0$296
;src/main.c:235: player_y--;
	ld	hl, #_player_y
	dec	(hl)
	C$main.c$236$4_0$296	= .
	.globl	C$main.c$236$4_0$296
;src/main.c:236: update_dng(test_dungeon,15,15);
	...
	ld	de, #_test_dungeon
	call	_update_dng
	C$main.c$238$3_0$295	= .
	.globl	C$main.c$238$3_0$295
;src/main.c:238: break;
	jp	00127$
	C$main.c$239$3_0$295	= .
	.globl	C$main.c$239$3_0$295
;src/main.c:239: case east:
00115$:
	C$main.c$240$3_0$295	= .
	.globl	C$main.c$240$3_0$295
;src/main.c:240: if(return_value(test_dungeon,15,15,player_x+1,player_y)==0x00||return_value(test_dungeon,15,15,player_x+1,player_y)==0x01){
	ld	b, e
	inc	b
	ld	a, (#_player_y)
...
;	spillPairReg hl
	...
	jp	NZ,00127$
00116$:
	C$main.c$241$4_0$297	= .
	.globl	C$main.c$241$4_0$297
;src/main.c:241: player_x++;
	ld	hl, #_player_x
	inc	(hl)
	C$main.c$242$4_0$297	= .
	.globl	C$main.c$242$4_0$297
;src/main.c:242: update_dng(test_dungeon,15,15);
	...
	ld	de, #_test_dungeon
	call	_update_dng
	C$main.c$244$3_0$295	= .
	.globl	C$main.c$244$3_0$295
;src/main.c:244: break;
	jp	00127$
	C$main.c$245$3_0$295	= .
	.globl	C$main.c$245$3_0$295
;src/main.c:245: case south:
00119$:
	C$main.c$246$3_0$295	= .
	.globl	C$main.c$246$3_0$295
;src/main.c:246: if(return_value(test_dungeon,15,15,player_x,player_y+1)==0x00||return_value(test_dungeon,15,15,player_x,player_y+1)==0x01){
	...
	jr	NZ, 00127$
00120$:
	C$main.c$247$4_0$298	= .
	.globl	C$main.c$247$4_0$298
;src/main.c:247: player_y++;
	ld	hl, #_player_y
	inc	(hl)
	C$main.c$248$4_0$298	= .
	.globl	C$main.c$248$4_0$298
;src/main.c:248: update_dng(test_dungeon,15,15);
	...
	ld	de, #_test_dungeon
	call	_update_dng
	C$main.c$250$3_0$295	= .
	.globl	C$main.c$250$3_0$295
;src/main.c:250: break;
	jr	00127$
	C$main.c$251$3_0$295	= .
	.globl	C$main.c$251$3_0$295
;src/main.c:251: case west:
00123$:
	C$main.c$252$3_0$295	= .
	.globl	C$main.c$252$3_0$295
...
;	spillPairReg hl
	...
	jr	NZ, 00127$
00124$:
	C$main.c$253$4_0$299	= .
	.globl	C$main.c$253$4_0$299
;src/main.c:253: player_x--;
	ld	hl, #_player_x
	dec	(hl)
	C$main.c$254$4_0$299	= .
	.globl	C$main.c$254$4_0$299
;src/main.c:254: update_dng(test_dungeon,15,15);
	...
	ld	de, #_test_dungeon
	call	_update_dng
	C$main.c$257$2_0$294	= .
	.globl	C$main.c$257$2_0$294
;src/main.c:257: }
00127$:
	C$main.c$258$2_0$294	= .
	.globl	C$main.c$258$2_0$294
;src/main.c:258: encounter_timer++;
	ld	hl, #_encounter_timer
	inc	(hl)
00129$:
	C$main.c$260$1_0$289	= .
	.globl	C$main.c$260$1_0$289
...
;src/main.c:234: if(return_value(test_dungeon,15,15,player_x,player_y-1)==0x00||return_value(test_dungeon,15,15,player_x,player_y-1)==0x01){
	ld	hl, #_player_y
	ld	c, (hl)
	C$main.c$261$2_0$300	= .
	.globl	C$main.c$261$2_0$300
...
;src/main.c:261: switch(player_dir){
	...
	jp	Z,00143$
	jp	00147$
	C$main.c$262$3_0$301	= .
	.globl	C$main.c$262$3_0$301
;src/main.c:262: case north:
00131$:
	C$main.c$263$3_0$301	= .
	.globl	C$main.c$263$3_0$301
;src/main.c:263: if(return_value(test_dungeon,15,15,player_x,player_y+1)==0x00||return_value(test_dungeon,15,15,player_x,player_y+1)==0x01){
	...
	jp	NZ,00147$
00132$:
	C$main.c$264$4_0$302	= .
	.globl	C$main.c$264$4_0$302
;src/main.c:264: player_y++;
	ld	hl, #_player_y
	inc	(hl)
	C$main.c$265$4_0$302	= .
	.globl	C$main.c$265$4_0$302
;src/main.c:265: update_dng(test_dungeon,15,15);
	...
	ld	de, #_test_dungeon
	call	_update_dng
	C$main.c$267$3_0$301	= .
	.globl	C$main.c$267$3_0$301
;src/main.c:267: break;
	jp	00147$
	C$main.c$268$3_0$301	= .
	.globl	C$main.c$268$3_0$301
;src/main.c:268: case east:
00135$:
	C$main.c$269$3_0$301	= .
	.globl	C$main.c$269$3_0$301
...
;	spillPairReg hl
	...
	jp	NZ,00147$
00136$:
	C$main.c$270$4_0$303	= .
	.globl	C$main.c$270$4_0$303
;src/main.c:270: player_x--;
	ld	hl, #_player_x
	dec	(hl)
	C$main.c$271$4_0$303	= .
	.globl	C$main.c$271$4_0$303
;src/main.c:271: update_dng(test_dungeon,15,15);
	...
	ld	de, #_test_dungeon
	call	_update_dng
	C$main.c$273$3_0$301	= .
	.globl	C$main.c$273$3_0$301
;src/main.c:273: break;
	jp	00147$
	C$main.c$274$3_0$301	= .
	.globl	C$main.c$274$3_0$301
;src/main.c:274: case south:
00139$:
	C$main.c$275$3_0$301	= .
	.globl	C$main.c$275$3_0$301
;src/main.c:275: if(return_value(test_dungeon,15,15,player_x,player_y-1)==0x00||return_value(test_dungeon,15,15,player_x,player_y-1)==0x01){
	...
	jr	NZ, 00147$
00140$:
	C$main.c$276$4_0$304	= .
	.globl	C$main.c$276$4_0$304
;src/main.c:276: player_y--;
	ld	hl, #_player_y
	dec	(hl)
	C$main.c$277$4_0$304	= .
	.globl	C$main.c$277$4_0$304
;src/main.c:277: update_dng(test_dungeon,15,15);
	...
	ld	de, #_test_dungeon
	call	_update_dng
	C$main.c$279$3_0$301	= .
	.globl	C$main.c$279$3_0$301
;src/main.c:279: break;
	jr	00147$
	C$main.c$280$3_0$301	= .
	.globl	C$main.c$280$3_0$301
;src/main.c:280: case west:
00143$:
	C$main.c$281$3_0$301	= .
	.globl	C$main.c$281$3_0$301
...
;	spillPairReg hl
	...
	jr	NZ, 00147$
00144$:
	C$main.c$282$4_0$305	= .
	.globl	C$main.c$282$4_0$305
;src/main.c:282: player_x++;
	ld	hl, #_player_x
	inc	(hl)
	C$main.c$283$4_0$305	= .
	.globl	C$main.c$283$4_0$305
;src/main.c:283: update_dng(test_dungeon,15,15);
	...
	ld	de, #_test_dungeon
	call	_update_dng
	C$main.c$286$2_0$300	= .
	.globl	C$main.c$286$2_0$300
;src/main.c:286: }
00147$:
	C$main.c$287$2_0$300	= .
	.globl	C$main.c$287$2_0$300
;src/main.c:287: encounter_timer++;
	ld	hl, #_encounter_timer
	inc	(hl)
00149$:
	C$main.c$289$1_0$289	= .
	.globl	C$main.c$289$1_0$289
;src/main.c:289: if(encounter_counter==encounter_timer){
	ld	a, (#_encounter_counter)
	ld	hl, #_encounter_timer
	sub	a, (hl)
	ret	NZ
	C$main.c$290$2_0$306	= .
	.globl	C$main.c$290$2_0$306
;src/main.c:290: global_state = 2;
	ld	hl, #_global_state
	ld	(hl), #0x02
	C$main.c$292$1_0$289	= .
	.globl	C$main.c$292$1_0$289
;src/main.c:292: }
	C$main.c$292$1_0$289	= .
	.globl	C$main.c$292$1_0$289
	...
	C$main.c$294$1_0$308	= .
	.globl	C$main.c$294$1_0$308
...
_state_switcher::
	ld	c, a
	C$main.c$295$1_0$308	= .
	.globl	C$main.c$295$1_0$308
;src/main.c:295: switch(t){
	...
	jp	(hl)
00115$:
	C$main.c$324$1_0$308	= .
	.globl	C$main.c$324$1_0$308
;src/main.c:324: }
	C$main.c$325$1_0$308	= .
	.globl	C$main.c$325$1_0$308
;src/main.c:325: }
	C$main.c$325$1_0$308	= .
	.globl	C$main.c$325$1_0$308
	...
	G$main$0$0	= .
	.globl	G$main$0$0
	C$main.c$327$1_0$311	= .
	.globl	C$main.c$327$1_0$311
;src/main.c:327: void main(void)
;	---------------------------------
; Function main
; ---------------------------------
_main::
	C$main.c$329$1_0$311	= .
	.globl	C$main.c$329$1_0$311
;src/main.c:329: init_dungeon(test_dungeon, 15, 15);
	...
	ld	de, #_test_dungeon
	call	_init_dungeon
	C$main.c$330$1_0$311	= .
	.globl	C$main.c$330$1_0$311
;src/main.c:330: init_dng_UI();
	call	_init_dng_UI
	C$main.c$331$1_0$311	= .
	.globl	C$main.c$331$1_0$311
;src/main.c:331: update_dng(test_dungeon,15,15);
	...
	ld	de, #_test_dungeon
	call	_update_dng
	C$main.c$349$1_0$311	= .
	.globl	C$main.c$349$1_0$311
;src/main.c:349: SHOW_SPRITES;
	ldh	a, (_LCDC_REG + 0)
	or	a, #0x02
	ldh	(_LCDC_REG + 0), a
	C$main.c$351$1_0$311	= .
	.globl	C$main.c$351$1_0$311
;src/main.c:351: while(1) {
00102$:
	C$main.c$354$2_0$312	= .
	.globl	C$main.c$354$2_0$312
;src/main.c:354: dungeon_logic_upd();
	call	_dungeon_logic_upd
	C$main.c$355$2_0$312	= .
	.globl	C$main.c$355$2_0$312
;src/main.c:355: update_dng_UI();
	call	_update_dng_UI
	C$main.c$367$2_0$312	= .
	.globl	C$main.c$367$2_0$312
;src/main.c:367: wait_vbl_done();
	call	_wait_vbl_done
	C$main.c$369$1_0$311	= .
	.globl	C$main.c$369$1_0$311
;src/main.c:369: }
	C$main.c$369$1_0$311	= .
	.globl	C$main.c$369$1_0$311
	XG$main$0$0	= .
